...
for k in list(range(0,5569)):
    ...
    while er_bol==1: #enquanto houver erro
        ...
        while connect_1==0:
            try:
                html_1=urlopen("https://www.fnde.gov.br/siope/dadosInformadosMunicipio.do?acao=pesquisar&pag=result&anos="+str(ano)+"&periodos=1&cod_uf="+str(estado)+"&municipios="+str(cod_mun)+"&admin=3&planilhas=246&descricaoItem=Transporte+Escolar&descricaodoItem=Educa%E7%E3o+Especial&nivel=") #abre a página
